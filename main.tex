...
Let $r\geq 1$. Let $G=(V,E)$ be a finite graph 
...
removing the edges $e_j$, $1\leq j\leq s$ from $T_1\cup T_2$ yields a spanning 
tree $T$ of $\tilde{G}$. 
...
\mathbf{1}_{\lambda(t_1,t_2,x)\in K_1\times K_2} \diff t_1 \diff t_2 \diff x \\
=&\int_{\mathbb{R}^s}\left(\int_{\mathbb{R}^{S_1}\times \mathbb{R}^{S_2}} 
\mathbf{1}_{(\varphi_{S_1}^x)^{-1}(t_1)\in K_1} 
\mathbf{1}_{(\varphi_{S_2}^x)^{-1}(t_2)\in K_2} \diff t_1 \diff t_2\right) \diff x\\
=&\int_{\mathbb{R}^{s}}\left(\int_{\mathbb{R}^{S_1}} 
\mathbf{1}_{(\varphi_{S_1}^x)^{-1}(t_1)\in K_1} \diff t_1\right) \cdot 
\left( \int_{\mathbb{R}^{S_2}}\mathbf{1}_{(\varphi_{S_2}^x)^{-1}(t_2)\in K_2}\diff t_2\right) \diff x\\
...
\begin{proof}
    ...
    $\partial G=\{ e^i := \left\{v_i,w_i\right\} ,1\leq i\leq m\}$ 
...
Suppose that $G\in \mathcal{G}_d$. 
    ...
    $e_\ell \subset \left\{v+s(v)\ed^{2(\ell+1)i\pi/3} \mathbb{R}_{\geq 0} \right\}$. 
    ...
    $e\subset \left\{v+s(v)\ed^{2(\ell+1) i\pi/3} \mathbb{R}_{\geq 0} \right\}$ and 
    $e\subset \left\{v'+s(v')\ed^{2(\ell'+1)i\pi/3} \mathbb{R}_{\geq 0} \right\}$.  
...
$e_{\ell+1}\leq e'_{\ell+1}$, $e_{\ell}>e'_{\ell}$. 
The same reasoning yields that $L(e)\geq L(e')$ if $e$ and $e'$ are of same 
type $\ell$ and $e_{\ell+1}\leq e'_{\ell+1}$, $e_{\ell}=e'_{\ell}$ 
...
$x^2_2\geq y^2_2$. Hence, the geodesics $\Phi(e)=[x^1,x^2]$ and 
...
If $i\leq d$, then $x=x_{v_{\tilde{e}}}$ for the edge $\tilde{e}\in \partial^{(2,0)}$ 
such that $L(\tilde{e})=1-\beta_i$ 
and $c(e)=1$. Since $\tilde{e}$ is of type $2$, $x_2=L(\tilde{e})=1-\beta_i$, and thus 
$$x_1=1-(1-\beta_i)=\beta_i \ .$$
If $d+1\leq i\leq n$, then $\tilde{e}\in\partial^{(1,1)}$, $L(\tilde{e})=\beta_i$ and $c(e)=0$. 
