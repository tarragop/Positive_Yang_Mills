...
see \eqref{eq:nb_vertices_edges_triangle}.
...
$\{v^1,\ldots,v^{3n}\}$, with the vertices $\{v^{ni+j},1\leq j\leq n\}$ located on $\partial_iT$.
\\
...
$\alpha^i_j=v^{ni+j}_{i+1}$ for $0\leq i\leq 2$ and $1\leq j\leq n$.
\\
\\
...
\begin{aligned} 
    ...
    &1-\beta_i&\text{if }c(e_{\ell n+i})=1
\end{aligned} \right . $$
for $\ell = 0$ and $1\leq i\leq n$ and replacing 
...
$L: E_{n, d} \to \R$ associates $(L(e))_{e \in S}$ is an integral isomorphism. 
