...
\noindent
Remark that the sum on the right hand-side is finite, 
...
=&\int_{\mathbb{R}^{n-1}}\indic_{1\geq u_1\geq\ldots\geq u_{n-1}\geq 0}\frac{1}{n}\prod_{i=1}^{n-1} du_i=\frac{1}{(n-1)!},
\end{align*}
